...
const shell = require('../../lib/deploy/shell');
const layout = require('../../lib/deploy/targets/layout');
const { createVault, isRef, refName } = require('../../lib/deploy/vault');
const { createRedactor } = require('../../lib/deploy/redact');
const { localExec, capture } = require('../../lib/deploy/exec');
