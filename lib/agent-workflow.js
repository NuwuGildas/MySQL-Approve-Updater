  ...
  async function turn(hold, sessionId, { message, guidance = '', moduleNote = '' }) {
    ...
    try {
      ...
      for (let step = 0; step <= maxSteps; step++) {
        ...
        const prompt = buildPrompt(sessionId, { moduleNote, transcriptExtra, guidance: answerOnly ? OUT_OF_STEPS_GUIDANCE : guidance });
        ...
        const call = answerOnly ? null : model.parseToolCall(outRaw, sessionId);
